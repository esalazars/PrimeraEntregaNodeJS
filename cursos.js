...
let cursos = [
    {id:'001', nombre:"Matematicas", duracion: "20 semanas",valor:60000},
    {id:'002', nombre:"Quimica", duracion: "12 semanas",valor:50000},
    {id:'003', nombre:"Fisica", duracion: "10 semanas",valor:40000},
    {id:'004', nombre:"Biologia", duracion: "20 semanas",valor:80000}
];
...
let buscarCurso = (iden) => {
    let resultado;
    if(cursos.find(curso => curso.id == iden)){//Find aplicado a la lista de cursos
